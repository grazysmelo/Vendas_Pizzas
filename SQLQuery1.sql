...
-- Variação da quantidade de pedidos para cada dia da semana
SELECT DATENAME(DW, order_date) AS order_day, COUNT(DISTINCT order_id) AS total_orders 
FROM pizza_sales
GROUP BY DATENAME(DW, order_date);

-- Variação da quantidade de pedidos para cada hora do dia
